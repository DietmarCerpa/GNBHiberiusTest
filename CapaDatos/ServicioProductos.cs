...
namespace CapaDatos
{
    public class ServicioProductos
    {
        ...
        public void ActualizarProductos(GNB_PRODUCTOS pProducto)
        {
            ...
            //
            GNB_PRODUCTOS revisionTabla = (from dato in pEntidad.GNB_PRODUCTOS where dato.ID_SKU == pProducto.ID_SKU select dato).ToList<GNB_PRODUCTOS>()[0];
            ...
            if (revisionTabla == null) throw new ArgumentException("NO existe esa ID_SKU");
            else
            {
                revisionTabla.ID_SKU = pProducto.ID_SKU;
